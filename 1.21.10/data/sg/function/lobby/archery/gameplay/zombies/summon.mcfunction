...
summon zombified_piglin ~ ~ ~ {Tags:["SGArcheryTarget","SGNewArcheryTarget"],attributes:[{id:"follow_range",base:100},{id:"max_health",base:5}],active_effects:[{id:"minecraft:speed",amplifier:0b,duration:-1,show_particles:0b}],Health:5,AngerTime:999999}
