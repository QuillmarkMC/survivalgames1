...
#map entities
kill @e[tag=map_glass]
summon item_display -219.50 12.1875 115.50 {Tags:["map_glass"],transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,0f,0f],scale:[4f,1f,4f]},item:{id:"minecraft:phantom_membrane",Count:1b,tag:{CustomModelData:1}}}
kill @e[tag=map_arrow]
summon item_display -219.21 11.0703125 115.40 {teleport_duration:1,Tags:["map_arrow"],item:{id:"minecraft:phantom_membrane",Count:1b,tag:{CustomModelData:2}}}
summon item_display -220.55 11.0703125 116.35 {teleport_duration:1,Tags:["map_arrow"],item:{id:"minecraft:phantom_membrane",Count:1b,tag:{CustomModelData:2}}}
summon item_display -220.34 11.0703125 114.29 {teleport_duration:1,Tags:["map_arrow"],item:{id:"minecraft:phantom_membrane",Count:1b,tag:{CustomModelData:2}}}
summon item_display -217.62 11.0703125 111.98 {teleport_duration:1,Tags:["map_arrow"],item:{id:"minecraft:phantom_membrane",Count:1b,tag:{CustomModelData:2}}}
summon item_display -217.71 11.0703125 117.06 {teleport_duration:1,Tags:["map_arrow"],item:{id:"minecraft:phantom_membrane",Count:1b,tag:{CustomModelData:2}}}
summon item_display -215.69 11.0703125 116.08 {teleport_duration:1,Tags:["map_arrow"],item:{id:"minecraft:phantom_membrane",Count:1b,tag:{CustomModelData:2}}}
summon item_display -216.81 11.0703125 115.23 {teleport_duration:1,Tags:["map_arrow"],item:{id:"minecraft:phantom_membrane",Count:1b,tag:{CustomModelData:2}}}
summon item_display -217.23 11.0703125 112.78 {teleport_duration:1,Tags:["map_arrow"],item:{id:"minecraft:phantom_membrane",Count:1b,tag:{CustomModelData:2}}}
summon item_display -220.39 11.0703125 118.46 {teleport_duration:1,Tags:["map_arrow"],item:{id:"minecraft:phantom_membrane",Count:1b,tag:{CustomModelData:2}}}
summon item_display -220.55 11.0703125 117.17 {teleport_duration:1,Tags:["map_arrow"],item:{id:"minecraft:phantom_membrane",Count:1b,tag:{CustomModelData:2}}}
