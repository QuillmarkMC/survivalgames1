...
execute if score $GracePeriod.State lobbySigns matches 3 run scoreboard players set $grace_period options 5
execute if score $GracePeriod.State lobbySigns matches 4 run scoreboard players set $grace_period options 15