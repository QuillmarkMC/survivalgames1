setblock -183 17 115 oak_wall_sign[facing=west]{GlowingText:true,Color:"red",Text1:'',Text2:'{"text":"Admin","color":"white","bold": false}',Text3:'{"text":"Settings","color":"white","bold": false}',Text4:""}
