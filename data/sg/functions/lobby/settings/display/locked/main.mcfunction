setblock -183 17 115 dark_oak_wall_sign[facing=west]{front_text:{messages:['{"text":""}', '{"text":"Map","color":"white","bold": false}', '{"text":"Settings","color":"white","bold": false}', '{"text":""}'], has_glowing_text: true, color: "red"}}
setblock -183 16 115 dark_oak_wall_sign[facing=west]{front_text:{messages:['{"clickEvent":{"action":"run_command","value": "/trigger lobbySigns set 1001"},"text": ""}', '{"text":"Start Game","color":"dark_green"}', '[{"text":"[","color": "white"},{"keybind":"key.use","color":"white"},{"text":"]","color": "white"}]', '{"text":""}'], has_glowing_text: true, color: "blue"}}
