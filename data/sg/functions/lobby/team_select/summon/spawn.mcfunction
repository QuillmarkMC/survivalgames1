...
execute at @e[type=marker,tag=TeamSelect,limit=1] run summon minecraft:text_display ~ ~1.25 ~ {Tags:["TeamSelectName","lobbyMarker"],alignment:"center",text:"",billboard:"center",background:0}
