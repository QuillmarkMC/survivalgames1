...
execute store result score #Temp teams if entity @a[team=Magenta]
...
execute if score #Temp teams < $MaxTeamSize teams run function sg:lobby/team_select/click_logic/magenta/join
