...
execute store result score #Temp teams if entity @a[team=Dark_Red]
...
execute if score #Temp teams < $MaxTeamSize teams run function sg:lobby/team_select/click_logic/dark_red/join
