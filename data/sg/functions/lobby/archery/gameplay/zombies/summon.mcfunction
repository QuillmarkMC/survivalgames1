...
summon zombified_piglin ~ ~ ~ {Tags:["SGArcheryTarget","SGNewArcheryTarget"],Attributes:[{Name:"generic.follow_range",Base:100},{Name:"generic.max_health",Base:1}],ActiveEffects:[{Id:24,Amplifier:0,Duration:999999,ShowParticles:false}],Health:1,AngerTime:999999}
