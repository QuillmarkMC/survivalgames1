execute if score $Debug options matches 1.. run say sg:lobby/1v1/arena1/start
#tag players
...
execute as @a[tag=SG1v1Arena1,limit=2] run function sg:lobby/effects/clear
...
tellraw @a[tag=SG1v1Arena1,limit=2] [{"text": ""},{"text":"[!] ","color":"gray","bold": true},{"translate":"text.lobby.1v1.generate"}]
