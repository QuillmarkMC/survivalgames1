execute if score $Debug options matches 1.. run say sg:lobby/1v1/arena2/start
#tag players
tag @a[tag=SG1v1Preparing,limit=2] add SG1v1Arena2
tag @a[tag=SG1v1Preparing,limit=2] remove SG1v1Preparing
tag @a[tag=SG1v1Arena2,limit=1] add SG1v1Player1Arena2
tag @a[tag=SG1v1Arena2,tag=!SG1v1Player1Arena2,limit=1] add SG1v1Player2Arena2
scoreboard players reset @a[tag=SG1v1Arena2,limit=2] 1v1QueuePosition
