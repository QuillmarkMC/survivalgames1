...
execute if score @s lobbyArenaRespawn matches ..0 if score @s respawnLocation = $Lobby.Default respawnLocation run tp @s @e[type=marker,tag=SGLobbySpawnPosition,limit=1]
