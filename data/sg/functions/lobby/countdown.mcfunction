...
execute if score $countdown_mod countdown matches 0 unless score $countdown countdown matches 0 as @a at @s run playsound block.note_block.hat record @s ~ ~ ~ 1 0.6
execute if score $countdown_mod countdown matches 1 as @a at @s run playsound block.note_block.hat record @s ~ ~ ~ 1 0.5
