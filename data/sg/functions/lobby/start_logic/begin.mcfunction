...
execute if score $ReadyNum lobbySigns matches 33.. run tellraw @s [{"text":"[!] ","color":"dark_red","bold": true},{"translate":"text.lobby.start.max_player_warning","color":"white","bold": false}]
