...
execute align xyz positioned ~0.5 ~-2.5 ~0.5 run summon armor_stand ~ ~ ~ {NoGravity:1,Invulnerable:1,Invisible:1,Passengers:[{id:"minecraft:shulker",NoGravity:1,Silent:1,Invulnerable:1,NoAI:1,AttachFace:0,Color:15b,Tags:["SGPlatform"],Rotation:[180.0f,0.0f]}],Tags:["SGPlatform","SGNewPlatform"]}
