...
execute if score $countdown countdown matches 1 run scoreboard players set $Piston countdown 3
execute if score $countdown countdown matches 1 run function sg:game/starting/platform/piston
