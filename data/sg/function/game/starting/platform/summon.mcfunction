...
execute align xyz positioned ~0.5 ~-3.0 ~0.5 run summon armor_stand ~ ~ ~ {NoGravity:1,Invulnerable:1,Invisible:1,Passengers:[{id:"minecraft:shulker",NoGravity:1,Silent:1,Invulnerable:1,NoAI:1,AttachFace:0,Color:15b,Tags:["SGPlatform"]}],Tags:["SGPlatform","SGNewPlatform"]}
