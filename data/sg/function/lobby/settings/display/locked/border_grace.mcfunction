...
setblock -183 17 118 dark_oak_wall_sign[facing=west]{front_text:{messages:['{"clickEvent":{"action":"run_command","value": "/trigger lobbySigns set 1017"},"text": ""}', '{"translate":"text.lobby.settings.signs.border_delay","color":"light_purple"}', '{"score":{"name":"$Num1","objective":"math"},"color":"red"}', '{"translate":"text.lobby.settings.signs.minutes","color":"gold"}'], has_glowing_text: true, color: "gray"}}
