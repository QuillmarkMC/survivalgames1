...
setblock -183 15 115 oak_wall_sign[facing=west]{front_text:{messages:[{"click_event":{"action":"run_command","command": "/trigger lobbySigns set 1004"},"text": ""}, {"translate":"text.lobby.settings.signs.unlock","color":"yellow"}, {"translate":"text.lobby.settings.signs.admin","color":"white"}, {"text":""}], has_glowing_text: true, color: "blue"},allow_op_features:true}
