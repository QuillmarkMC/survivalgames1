...
setblock -183 16 115 dark_oak_wall_sign[facing=west]{front_text:{messages:['{"clickEvent":{"action":"run_command","value": "/trigger lobbySigns set 1001"},"text": ""}', '{"translate":"text.lobby.settings.signs.start","color":"dark_green"}', '[{"text":"[","color": "white"},{"keybind":"key.use","color":"white"},{"text":"]","color": "white"}]', '{"text":""}'], has_glowing_text: true, color: "blue"}}
...
setblock -183 15 115 oak_wall_sign[facing=west]{front_text:{messages:['{"clickEvent":{"action":"run_command","value": "/trigger lobbySigns set 1004"},"text": ""}', '{"translate":"text.lobby.settings.signs.unlock","color":"yellow"}', '{"translate":"text.lobby.settings.signs.admin","color":"white"}', '{"text":""}'], has_glowing_text: true, color: "blue"}}
