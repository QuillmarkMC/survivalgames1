...
setblock -183 16 115 oak_wall_sign[facing=west]{front_text:{messages:[{"click_event":{"action":"run_command","command": "/trigger lobbySigns set 1"},"text": ""}, {"translate":"text.lobby.settings.signs.start","color":"dark_green"}, [{"text":"[","color": "white"},{"keybind":"key.use","color":"white"},{"text":"]","color": "white"}], {"text":""}], has_glowing_text: true, color: "blue"},allow_op_features:true}
