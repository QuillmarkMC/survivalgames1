...
scoreboard players set $aj.timer_new.animation.animation.model.timer_activate aj.id 0
scoreboard players set $aj.timer_new.animation.animation.model.rotating aj.id 1
...
scoreboard players set aj.timer_new.export_version aj.i 79924304
