...
execute if score @s aj.timer_new.animation.animation.model.rotating.local_anim_time matches 80.. run function zzz_timer_new_internal:animations/animation.model.rotating/end