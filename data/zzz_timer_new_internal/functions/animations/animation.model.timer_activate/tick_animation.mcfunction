...
execute if score @s aj.timer_new.animation.animation.model.timer_activate.local_anim_time matches 311.. run function zzz_timer_new_internal:animations/animation.model.timer_activate/end