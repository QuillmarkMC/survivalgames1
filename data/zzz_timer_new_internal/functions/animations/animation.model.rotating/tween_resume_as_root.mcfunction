function zzz_timer_new_internal:animations/animation.model.rotating/resume_as_root
function zzz_timer_new_internal:animations/animation.model.rotating/tween_as_root
